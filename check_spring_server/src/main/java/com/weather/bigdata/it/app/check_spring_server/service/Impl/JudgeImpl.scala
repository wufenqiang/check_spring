...
import com.weather.bigdata.it.app.check_spring_server.service.Judge
import com.weather.bigdata.it.app.check_spring_server.utils.judge.{JudgeType, ReadURL}
...
class JudgeImpl extends Judge{
  ...
  override def checkTime(data_time: Date, dt: Long, update_time: Date, dupt: Long): (JudgeType, String) = {
    val now = new Date()
    var msg:String=""
