...
@Component
@PropertySource(value = "classpath:${spring.profiles.active}/contacts.properties",encoding = "utf-8")
public class ContactsProp {
    ...
    private Properties loadProperties() {
        ...
        InputStream inputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("dev/contacts.properties");
