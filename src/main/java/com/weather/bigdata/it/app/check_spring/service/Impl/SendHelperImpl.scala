...
import com.weather.bigdata.it.app.check_spring.prop.{ContactsProp, SettingProp}
...
import com.weather.bigdata.it.app.check_spring.utils.send.HttpUtil
...
class SendHelperImpl extends SendHelper{
  ...
  override def beat(heartbeatTitle: String): lang.Boolean = {
  ...
  override def text(access_tokens: util.Set[String], title: String, text: String, outurl: String,pushtype: Integer): lang.Boolean = {
  ...
  override def text(token: String, title: String, text: String, outurl: String, pushtype: Integer): lang.Boolean = {
    ...
    if(result==null){
      ...
      if(result.equals("")){
        ...
        log.info("MonitoringSystem发送信息:"+hashMap.toString+";MonitoringSystem返回值:{}", result)
  ...
  override def text(token: String, title: String, text: String, pushtype: Integer): lang.Boolean = {
